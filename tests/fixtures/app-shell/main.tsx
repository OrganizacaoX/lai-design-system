...
function Fixture() {
  ...
  return (
    <AppShell
      brand="Fixture"
      navigation={[
        { id: "empty", label: "Hidden group", items: [] },
        {
          id: "main",
      ...
      footer={
        <SidebarProfile
          user={{ name: "Ana Silva", image: "/missing-avatar.png" }}
          profile={{ render: <a href="#profile" /> }}
          organization={{ disabled: true, onSelect: () => {} }}
          labels={{
            trigger: "Account",
            profile: "Profile",
            signOut: "Sign out",
