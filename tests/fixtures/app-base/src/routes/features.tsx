...
export const Route = createFileRoute("/features")({
  loader: async () => ({ secondary: await secondaryI18n }),
  component: Features,
});
const data = [
  { id: "1", name: "Bruno" },
  ...
  return (
    <>
      ...
      <p data-testid="number">
        {createLocaleFormatters(language).number(1234.5)}
      </p>
      <I18nextProvider i18n={secondary}>
        <Isolated />
      </I18nextProvider>
      <section aria-label="Defaults">
        <DataTable
          ...
          bulkActions={[{ label: "Action", onAction: () => {} }]}
        />
        <DataPagination
          page={1}
          totalPages={2}
