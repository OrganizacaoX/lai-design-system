...
export function ComponentAccessibility({ id }: { id: string }) {
  ...
  return (
    <section aria-labelledby="accessibility-title" className="space-y-4">
      <h2 id="accessibility-title" className="text-xl font-semibold">
        Acessibilidade
      </h2>
      <p className="text-sm text-muted-foreground">
        Use estas orientações ao compor e validar o componente no seu produto. A
        acessibilidade também depende dos rótulos, do conteúdo e das interações
        da página.
      </p>
