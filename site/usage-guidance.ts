export const usageGuidance: Record<string, string> = {
  ...
  "app-update-card":
    "Use quando o app detectar uma versão nova: o card avisa sem bloquear a tela e só atualiza no clique da pessoa. Passe description quando atualizar naquele momento custar algo (uma ligação, um formulário aberto). A tela de progresso assume o app depois do clique; informe onClearCache apenas quando o app tiver uma saída além do retry. A detecção da versão é do produto — o design system só entrega a interface.",
