      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Exemplo de ação do menu de perfil. No produto, esta ação abre o
...
export function AppShellExample() {
  ...
  return (
    ...
    >
      <PageHeader
        title={title}
        description="Acompanhe o trabalho da sua equipe."
      />
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        {["Atividade da equipe", "Próximas tarefas"].map((label) => (
