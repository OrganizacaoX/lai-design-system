...
export const laiTranslations = {
  "pt-BR": {
    ...
    "appUpdate.checkConnection": "Verifique sua conexão e tente novamente.",
    "appUpdate.clearCache": "Limpar cache e reiniciar",
  ...
  en: {
    ...
    "appUpdate.checkConnection": "Check your connection and try again.",
    "appUpdate.clearCache": "Clear cache and restart",
  ...
  es: {
    ...
    "appUpdate.checkConnection": "Compruebe su conexión e inténtelo de nuevo.",
    "appUpdate.clearCache": "Borrar caché y reiniciar",
