...
function ToastContent({ className, ...props }: ToastPrimitive.Content.Props) {
  return (
    <ToastPrimitive.Content
      ...
      className={cn(
        "flex h-full items-center gap-3 overflow-hidden p-4 transition-opacity duration-250 ease-out-expo data-behind:opacity-0 data-expanded:opacity-100",
        className,
      )}
      {...props}
    />
...
function ToastClose({
  ...
  return (
    <ToastPrimitive.Close
      ...
      render={render}
      className={cn(
        "relative shrink-0 text-muted-foreground after:absolute after:-inset-2 after:content-empty hover:text-foreground",
        className,
      )}
      {...props}
    >
