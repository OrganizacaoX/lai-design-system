...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-lh w-fit min-w-questionnaire text-xs font-medium text-muted-foreground tabular-nums",
        className,
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-5 shrink-0 translate-y-choice-offset items-center justify-center rounded-md border border-input bg-background font-mono text-(length:--text-micro) leading-none font-medium text-muted-foreground group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  );
}
