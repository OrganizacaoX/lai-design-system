  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "flex-1 rounded-(--cell-radius) text-(length:--text-control-sm) font-normal text-muted-foreground select-none",
        ...
        week_number: cn(
          "text-(length:--text-control-sm) text-muted-foreground select-none",
